...
# Ahead of the /<dashboard_id> rule, the way /api/queries/archive is registered
# ahead of /api/queries/<query_id>, so "archive" is never read as an id.
api.add_org_resource(DashboardArchiveResource, "/api/dashboards/archive", endpoint="dashboards_archive")
...
api.add_org_resource(
    PublicVisualizationResource,
    "/api/visualizations/public/<token>",
    endpoint="public_visualization",
)
api.add_org_resource(
    VisualizationShareResource,
    "/api/visualizations/<visualization_id>/share",
    endpoint="visualization_share",
)
api.add_org_resource(
    VisualizationResource,
