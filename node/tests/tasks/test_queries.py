...
class HistoricalCaptureHookTests(BaseTestCase):
    def _query_with_capture_enabled(self):
    ...
    def _run_success(self, query, capture, scheduled_query_id=None, user_id=None):
        with patch.object(PostgreSQL, "run_query") as qr:
    ...
    def test_does_not_fire_for_manual_run_even_with_flag_enabled(self, capture, _):
        query = self._query_with_capture_enabled()
