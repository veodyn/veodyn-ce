...
class ErrorId(StrEnum):
    ...
    CONNECTOR_NOT_REGISTERED = "VEODYN_CONNECTOR_NOT_REGISTERED"
    CONNECTOR_NOT_CONFIGURED = "VEODYN_CONNECTOR_NOT_CONFIGURED"
    CONNECTOR_ALREADY_CONFIGURED = "VEODYN_CONNECTOR_ALREADY_CONFIGURED"
    CONNECTOR_CREDENTIALS_REFUSED = "VEODYN_CONNECTOR_CREDENTIALS_REFUSED"
    MESSAGE_EDIT_LOCKED = "VEODYN_MESSAGE_EDIT_LOCKED"
    MESSAGE_REVISION_STALE = "VEODYN_MESSAGE_REVISION_STALE"
    PUBLISHED_FEED_HAS_NO_STATIC_DATASET = "VEODYN_PUBLISHED_FEED_HAS_NO_STATIC_DATASET"
    PUBLISHED_FEED_ENTITY_LOOKUP_UNAVAILABLE = "VEODYN_PUBLISHED_FEED_ENTITY_LOOKUP_UNAVAILABLE"
    AI_TURN_TIMEOUT = "VEODYN_AI_TURN_TIMEOUT"
    AI_TURN_LOST = "VEODYN_AI_TURN_LOST"
    AI_TURN_CONFLICT = "VEODYN_AI_TURN_CONFLICT"
    AI_TOOL_RESULT_REJECTED = "VEODYN_AI_TOOL_RESULT_REJECTED"
    AI_CHAT_NOT_FOUND = "VEODYN_AI_CHAT_NOT_FOUND"
    AI_CHAT_UNAVAILABLE = "VEODYN_AI_CHAT_UNAVAILABLE"
