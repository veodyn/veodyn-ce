...
def downgrade() -> None:
    ...
    if queryless_feeds or queryless_attempts:
        raise IrreversibleRows(
            "0017 cannot be reversed while rows exist that 0016 has nowhere to put: "
            ...
            "and the schema at 0016 declares both columns NOT NULL. Bind those feeds to a query or delete "
