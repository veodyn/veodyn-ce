...
function Button({
  ...
  // base-ui defaults nativeButton to true, which stamps type="button" on the
  // rendered element and warns when `render` replaces the <button> with a
  // non-button (a Link or anchor). Derive it from the render element so
  // render={<Link/>} is treated as non-native automatically. An explicit
