...
export const mockDatasets: Dataset[] = [
  {
    ...
    freshness: { lastUpdatedAt: '2026-07-21T06:00:00Z', status: 'fresh', captureId: 'route-counts-daily' },
  ...
  },
  {
    ...
    freshness: { lastUpdatedAt: '2026-07-22T05:55:00Z', status: 'fresh', captureId: 'bikeshare-gbfs' },
  ...
  },
  {
    ...
    freshness: { lastUpdatedAt: '2026-07-10T23:00:00Z', status: 'stale', captureId: 'bikeshare-trip-ledger' },
  ...
  },
  {
    ...
    freshness: { lastUpdatedAt: '2026-07-21T06:00:00Z', status: 'fresh', captureId: 'rail-scada' },
  ...
  },
  {
    ...
    freshness: { lastUpdatedAt: '2026-07-22T04:30:00Z', status: 'fresh', captureId: 'traffic-incidents' },
  ...
  },
  {
    ...
    freshness: { lastUpdatedAt: '2026-07-22T05:59:00Z', status: 'fresh', captureId: 'fleet-avl' },
  ...
  },
  {
    ...
    freshness: { lastUpdatedAt: '2026-06-30T15:00:00Z', status: 'stale', captureId: 'camera-inventory' },
  ...
  },
  {
    ...
    freshness: { lastUpdatedAt: '2026-07-22T04:00:00Z', status: 'fresh', captureId: 'aqi-hourly' },
