...
// Feed ids match the freshness.feedId values on this pack's catalog datasets.
// Order, cadences, receipt timestamps and the status sequence are independent
// of the private tenant pack's feed list on purpose: this file used to carry
// the same order, the same cadences and the same timestamps down to the
// minute, which let the two packs be diffed against each other row by row.
